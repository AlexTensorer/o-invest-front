      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 ">
        <div className="md:col-span-1 l">
          <div className="bg-gradient-to-r from-[#080b29] via-[#1a1c60] to-[#1a1c60] border border-indigo-900 p-10 rounded-2xl shadow-lg h-full ">
            <h2 className="text-xl text-white mb-2">Bonjour,</h2>
            <br />
            <h3 className="text-6xl text-white font-bold mb-4 " style={{ overflowWrap: 'break-word' }}> {firstName} {lastName} </h3>
            <br />
            {portfolios.length === 0 ? (
              <p className='text-white'>Vous n'avez pas de portefeuilles. Créez-en un pour commencer.</p>
            ) : (
              <>
                <p className='text-white italic'>Nous sommes ravis de vous revoir.</p>
                <p className='text-white italic'>Jetons un coup d'œil à la performance de vos fonds aujourd'hui.</p>
