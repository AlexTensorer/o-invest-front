...
<section className="bg-transparent body-font overflow-hidden text-white">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <b className='bg-clip-text text-2xl md:text-3xl text-indigo-500 ml-2'>Investissez dans le meilleur service de gestion de portefeuilles.</b>
    </div>
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
          ...
          <p className="flex items-center mb-2">
            ...
            </span>Nombre de portefeuilles :  2 Max
          </p>
          <p className="flex items-center mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 rounded-full ">
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
          ...
          <p className="flex items-center mb-2">
            ...
            </span>Nombre de portefeuilles <b className='bg-clip-text text-indigo-400 ml-2'> illimité</b>
          </p>
          <p className="flex items-center mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 rounded-full ">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" className="w-3 h-3" viewBox="0 0 24 24">
          ...
          <p className="flex items-center mb-2">
            ...
            </span>Nombre d'actifs <b className='bg-clip-text text-indigo-400 ml-2'> illimité</b>
          </p>
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
          ...
          <p className="flex items-center mb-2">
            ...
            </span>Types d'Actifs <b className='bg-clip-text text-indigo-400 ml-2'>Cryptos, ETF...  </b></p>
          ...
          <p className="text-xs mt-3">Pour les professionnels de l'investissement </p>
        </div>
      </div>
    </div>
  </div>
