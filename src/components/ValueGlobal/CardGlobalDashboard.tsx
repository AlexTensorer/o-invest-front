...
const CardGlobal = () => {
  ...
  return (
    <div style={containerStyle} className=" border border-indigo-900 hover:border-dotted p-10 rounded-2xl shadow-lg h-full">
      <div className="relative flex w-full justify-center content-start text-white text-4xl mb-2  p-2 font-bold">Valorisation Globale</div>
        <p className="text-lg text-white font-bold my-6"> <MainNumberDisplay value={parseFloat(userPortfolioValuation).toFixed(2)} /></p>
      
      
      <div className="grid grid-cols-2 grid-rows-2 gap-4">
        <div className="text-lg text-white"> Total investi </div>
        <div className="text-lg text-white">Gains / Pertes</div>
        <div className="text-lg text-white"> <SubNumberDisplay value={totalInvested.toFixed(2)}/></div>
